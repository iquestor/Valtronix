...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <table style="width:47%; class="auto-style38">
                <tr bgcolor="#507486">
                    ...
                    <td align="Center" class="auto-style68">Robot 2 Outfeed 2</td>
                </tr>
                <tr bgcolor="#507486">
                    <td align="Center" colspan="4" class="auto-style72"><H2 class="auto-style71"><font color="White">Current Order Number</H2></font></td>
                </tr>
                <tr>
                    ...
                    <td valign="Middle" class="auto-style69">
                ...
                <tr bgcolor="#507486">
                    <td align="Center" class="auto-style72" colspan="4"><H2 class="auto-style71"><font color="White">Trays Unscanned</H2></font></td>
                </tr>
                <tr>
                    <td valign="Top" class="auto-style54">
                        <asp:GridView ID="viewStation5" runat="server" AutoGenerateColumns="False" DataKeyNames="MailTrayID" DataSourceID="SqlDataSource5" Height="16px" PageSize="1" ShowHeaderWhenEmpty="True" HorizontalAlign="Center" CssClass="auto-style66" Font-Size="Medium" Width="170px">
                    ...
                    <td valign="Top" class="auto-style54">
                        <asp:GridView ID="viewStation6" runat="server" AutoGenerateColumns="False" DataKeyNames="MailTrayID" DataSourceID="SqlDataSource6" Height="16px" PageSize="1" ShowHeaderWhenEmpty="True" Width="170px" HorizontalAlign="Center" CssClass="auto-style66" Font-Size="Medium">
                            <AlternatingRowStyle ForeColor="#0066FF" />
                            <Columns>
                                <asp:BoundField DataField="MailTrayID" HeaderText="MailTrayID" ReadOnly="True" SortExpression="MailTrayID" />
                                <asp:BoundField DataField="Half" HeaderText="Half" SortExpression="Half" />
                    ...
                    <td valign="Top" class="auto-style55">
                        <asp:GridView ID="viewStation7" runat="server" AutoGenerateColumns="False" DataKeyNames="MailTrayID" DataSourceID="SqlDataSource7" Height="18px" PageSize="1" ShowHeaderWhenEmpty="True" HorizontalAlign="Center" CssClass="auto-style66" Font-Size="Medium" Width="171px">
                            <AlternatingRowStyle ForeColor="#0066FF" />
                            <Columns>
                                <asp:BoundField DataField="MailTrayID" HeaderText="MailTrayID" ReadOnly="True" SortExpression="MailTrayID" />
                                <asp:BoundField DataField="Half" HeaderText="Half" SortExpression="Half" />
                    ...
                    <td valign="Top" class="auto-style70">
                        <asp:GridView ID="viewStation8" runat="server" AutoGenerateColumns="False" DataKeyNames="MailTrayID" DataSourceID="SqlDataSource8" Height="21px" PageSize="1" ShowHeaderWhenEmpty="True" Width="170px" HorizontalAlign="Center" CssClass="auto-style66" Font-Size="Medium">
                            <AlternatingRowStyle ForeColor="#0066FF" />
                            <Columns>
                                <asp:BoundField DataField="MailTrayID" HeaderText="MailTrayID" ReadOnly="True" SortExpression="MailTrayID" />
                                <asp:BoundField DataField="Half" HeaderText="Half" SortExpression="Half" />
                ...
                <tr bgcolor="#507486">
                    <td align="Center" class="auto-style72" colspan="4"><H2 class="auto-style71"><font color="White">Solved Patterns</font></H2></td>
                </tr>
                <tr>
                    <td valign="Top" class="auto-style54">
                        <asp:GridView ID="viewStation9" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource9" Height="16px" PageSize="1" ShowHeaderWhenEmpty="True" HorizontalAlign="Center" CssClass="auto-style66" Font-Size="Medium">
                            <AlternatingRowStyle ForeColor="#0066FF" />
                            <Columns>
                                <asp:BoundField DataField="Layer_#" HeaderText="Layer_#" SortExpression="Layer_#" />
        ...
        <asp:SqlDataSource ID="SqlDataSource9" runat="server" ConnectionString="<%$ ConnectionStrings:ctmConnectionString %>" SelectCommand="Select fanuc_num as 'Layer_#', fanuc_num_m as Mirrored from solved_patterns where palletid = (select palletid from current_pallet where station_num = 1)" ></asp:SqlDataSource>
        <asp:SqlDataSource ID="SqlDataSource10" runat="server" ConnectionString="<%$ ConnectionStrings:ctmConnectionString %>" SelectCommand="Select fanuc_num as Layer_#, fanuc_num_m as Mirrored from solved_patterns where palletid = (select palletid from current_pallet where station_num = 2)" ></asp:SqlDataSource>
        ...
        <asp:SqlDataSource ID="SqlDataSource11" runat="server" ConnectionString="<%$ ConnectionStrings:ctmConnectionString %>" SelectCommand="Select fanuc_num as Layer_#, fanuc_num_m as Mirrored from solved_patterns where palletid = (select palletid from current_pallet where station_num = 3)" ></asp:SqlDataSource>
        ...
        <asp:SqlDataSource ID="SqlDataSource12" runat="server" ConnectionString="<%$ ConnectionStrings:ctmConnectionString %>" SelectCommand="Select fanuc_num as Layer_#, fanuc_num_m as Mirrored from solved_patterns where palletid = (select palletid from current_pallet where station_num = 4)" ></asp:SqlDataSource>
        </div>
    </form>
</body>
</html>
